/**
 * Structured logger (pino-based) — session-stream-handler Lambda
 *
 ...
 * a single structured event. Each field (level, time, scope, ...) becomes
 * queryable via `fields @timestamp, scope, msg` etc.
 *
 * ## Output format
 *
